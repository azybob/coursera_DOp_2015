...
def basic_prompt():
    """Prompt the user for login credentials. Returns a tuple (login, password)."""
    login = 's81415000@gmail.com' #raw_input('Login (Email address): ')
    password = 'FVmPZN4rwM' #raw_input('Submission Password (from the programming assignments page. This is NOT your own account\'s password): ')
    return (login, password)
